...
Para ello, y antes del diseño, es necesario un análisis de los requerimientos, no sólo actuales, sino también futuros, así como para la implementación de un vehículo aéreo no tripulado. El circuito impreso debería poder albergar los siguientes componentes y comportamientos:
...
\begin{itemize}
	...
	\item Se dispone para el usuario final la posibilidad de unos "jumper" para dar la opción al usuario sobe quién gobernará la comunicación I2C, la FPGA o el micro-controlador, para el cuál se podrán usar los conectores del apartado anterior.\newline
