...
En esta sección se propone una solución al problema planteado proporcionando la solución final del sistema propuesto, con un alto nivel de abstracción. En la sección \ref{sec:Implementacion} se profundizará aún más en los detalles de los diferentes sub-sistemas que aquí se exponen.
...
\subsection{Controlador de motores en IceZum Alhambra}
