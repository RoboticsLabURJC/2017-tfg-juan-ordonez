{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "69188cdf-ac43-47db-a757-404c373bf062",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "79f62cb4-a55b-4691-8a10-88642465b6ba",
          "type": "basic.constant",
          "data": {
            "name": "ehr",
            "value": "16'd10000",
        ...
        {
          "id": "8c49de75-a47c-4178-ac8a-1a1c952d4c37",
          "type": "basic.constant",
          "data": {
            "name": "ehr2",
            "value": "16'd13000",
        ...
        {
          "id": "c221b9db-83b1-4ff8-bca3-48f083d9010e",
          "type": "ae0b2f67ffbdfdea7a156518f0229a9f085c78d1",
          "position": {
            "x": -4040,
            "y": -2024
          },
        ...
        {
          "id": "1a969ff3-0dcd-4d4d-865b-5f94150451fb",
          "type": "basic.code",
          "data": {
        ...
        {
          "id": "d1bc28b6-1f17-45d3-b202-9dca50388f15",
        ...
        {
          "id": "ec595476-c417-4317-af8f-0a28fbb45811",
          "type": "a210abb63fdcd96f792e6567f116352bdb6bd14b",
          "position": {
            "x": -3760,
            "y": -2904
        ...
        {
          "id": "ebd9c932-550d-494d-b33a-2b9c6b2b33dc",
          "type": "basic.code",
          "data": {
        ...
        {
          "id": "d4140a65-ea4e-4ce4-b212-803950af6867",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "c221b9db-83b1-4ff8-bca3-48f083d9010e",
        ...
        },
        {
          ...
          "target": {
            "block": "1a969ff3-0dcd-4d4d-865b-5f94150451fb",
            "port": "Kd"
          }
        },
        {
          "source": {
            "block": "79f62cb4-a55b-4691-8a10-88642465b6ba",
            "port": "constant-out"
          },
          "target": {
            "block": "d1bc28b6-1f17-45d3-b202-9dca50388f15",
        ...
        {
          "source": {
            "block": "8c49de75-a47c-4178-ac8a-1a1c952d4c37",
            "port": "constant-out"
          },
          "target": {
            "block": "ec595476-c417-4317-af8f-0a28fbb45811",
            "port": "64d095fc-7dca-4f9d-9c73-9fcd9e0ed0a7"
          }
        },
        {
        ...
        {
          "source": {
            "block": "ebd9c932-550d-494d-b33a-2b9c6b2b33dc",
            "port": "velocity1"
          },
          "target": {
            "block": "7b737384-b3a4-4adc-b35d-e9327a4ac7c4",
        ...
        },
        {
          ...
          "target": {
            "block": "69188cdf-ac43-47db-a757-404c373bf062",
            "port": "in"
          }
        },
        {
  ...
  "dependencies": {
    ...
    "ae0b2f67ffbdfdea7a156518f0229a9f085c78d1": {
      "package": {
        "name": "Control_P",
        "version": "v1.0.0",
        "description": "",
